export let products = [
  ...
  },
  {
    ...
    stock: "12",
    description:
      "This free embroidery design features an intricate vase, accompanied with a small floral arrangement. Stitch in an array of vibrant DMC Mouliné Spécial shades to capture the soft texture of the petals and detailed vase. It will make a great addition to cushion covers, tote bags and home linens. Our clear patterns and quality supplies make it easy for you to complete your project. Colourfast and fade resistant DMC threads keep stitches looking vibrant for generations to come.    ",
    category: "Patterns",
    img: "https://res.cloudinary.com/dxktpvzbw/image/upload/v1713841712/dmc/open-uri20230919-2-ttec9k_bixjrh.jpg",
  },
  {
    id: "3",
